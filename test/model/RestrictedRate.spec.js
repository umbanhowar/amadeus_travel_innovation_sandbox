...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.RestrictedRate();
  });
  ...
  describe('RestrictedRate', function() {
    it('should create an instance of RestrictedRate', function() {
      // uncomment below and update the code to test RestrictedRate
      //var instane = new AmadeusTravelInnovationSandbox.RestrictedRate();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.RestrictedRate);
    });

    it('should have the property rateCode (base name: "rate_code")', function() {
