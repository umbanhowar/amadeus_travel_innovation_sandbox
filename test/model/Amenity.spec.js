...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Amenity();
  });
  ...
  describe('Amenity', function() {
    it('should create an instance of Amenity', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Amenity();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Amenity);
    });
    ...
    it('should have the property otaCode (base name: "ota_code")', function() {
      // uncomment below and update the code to test the property otaCode
      //var instane = new AmadeusTravelInnovationSandbox.Amenity();
      //expect(instance).to.be();
    });
