...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Company();
  });
  ...
  describe('Company', function() {
    it('should create an instance of Company', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Company();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Company);
    });
