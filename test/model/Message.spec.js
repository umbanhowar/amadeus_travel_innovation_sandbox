...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Message();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Message);
    });
