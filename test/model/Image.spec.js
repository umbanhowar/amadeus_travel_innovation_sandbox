...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Image();
  });
  ...
  describe('Image', function() {
    it('should create an instance of Image', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Image();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Image);
    });
