...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Station();
  });
  ...
  describe('Station', function() {
    it('should create an instance of Station', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Station();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Station);
    });
