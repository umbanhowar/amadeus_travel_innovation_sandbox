...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Link();
  });
  ...
  describe('Link', function() {
    it('should create an instance of Link', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Link();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Link);
    });
