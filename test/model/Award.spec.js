...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Award();
  });
  ...
  describe('Award', function() {
    it('should create an instance of Award', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Award();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Award);
    });
