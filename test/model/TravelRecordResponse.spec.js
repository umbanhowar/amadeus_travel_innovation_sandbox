...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.TravelRecordResponse();
  });
  ...
  describe('TravelRecordResponse', function() {
    it('should create an instance of TravelRecordResponse', function() {
      // uncomment below and update the code to test TravelRecordResponse
      //var instane = new AmadeusTravelInnovationSandbox.TravelRecordResponse();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.TravelRecordResponse);
    });

    it('should have the property recordLocator (base name: "record_locator")', function() {
      // uncomment below and update the code to test the property recordLocator
      //var instane = new AmadeusTravelInnovationSandbox.TravelRecordResponse();
