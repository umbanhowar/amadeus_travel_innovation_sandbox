...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.FlightReservationSegment();
  });
  ...
  describe('FlightReservationSegment', function() {
    it('should create an instance of FlightReservationSegment', function() {
      // uncomment below and update the code to test FlightReservationSegment
      //var instane = new AmadeusTravelInnovationSandbox.FlightReservationSegment();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.FlightReservationSegment);
    });
