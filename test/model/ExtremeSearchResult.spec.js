...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.ExtremeSearchResult();
  });
  ...
  describe('ExtremeSearchResult', function() {
    it('should create an instance of ExtremeSearchResult', function() {
      // uncomment below and update the code to test ExtremeSearchResult
      //var instane = new AmadeusTravelInnovationSandbox.ExtremeSearchResult();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.ExtremeSearchResult);
    });
    ...
    it('should have the property returnDate (base name: "return_date")', function() {
