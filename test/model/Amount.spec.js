...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Amount();
  });
  ...
  describe('Amount', function() {
    it('should create an instance of Amount', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Amount();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Amount);
    });
