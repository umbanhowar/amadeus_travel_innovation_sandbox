...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Vehicle();
  });
  ...
  describe('Vehicle', function() {
    it('should create an instance of Vehicle', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Vehicle();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Vehicle);
    });

    it('should have the property vehicleInfo (base name: "vehicle_info")', function() {
    ...
    it('should have the property estimatedTotal (base name: "estimated_total")', function() {
