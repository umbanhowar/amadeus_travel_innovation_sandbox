...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Logos();
  });
  ...
  describe('Logos', function() {
    it('should create an instance of Logos', function() {
      // uncomment below and update the code to test Logos
      //var instane = new AmadeusTravelInnovationSandbox.Logos();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Logos);
    });
