...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Airport();
  });
  ...
  describe('Airport', function() {
    it('should create an instance of Airport', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Airport();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Airport);
    });
