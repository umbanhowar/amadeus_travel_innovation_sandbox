...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Rate();
  });
  ...
  describe('Rate', function() {
    it('should create an instance of Rate', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Rate();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Rate);
    });
