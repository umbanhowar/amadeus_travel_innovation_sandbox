...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.AffiliateSearchResult();
  });
  ...
  describe('AffiliateSearchResult', function() {
    it('should create an instance of AffiliateSearchResult', function() {
      // uncomment below and update the code to test AffiliateSearchResult
      //var instane = new AmadeusTravelInnovationSandbox.AffiliateSearchResult();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.AffiliateSearchResult);
    });
    ...
    it('should have the property deepLink (base name: "deep_link")', function() {
