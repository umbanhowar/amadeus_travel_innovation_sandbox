...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.Contact();
  });
  ...
  describe('Contact', function() {
    it('should create an instance of Contact', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.Contact();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.Contact);
    });
