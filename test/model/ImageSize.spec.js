...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.ImageSize();
  });
  ...
  describe('ImageSize', function() {
    it('should create an instance of ImageSize', function() {
      ...
      //var instane = new AmadeusTravelInnovationSandbox.ImageSize();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.ImageSize);
    });
