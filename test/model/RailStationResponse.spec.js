...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmadeusTravelInnovationSandbox.RailStationResponse();
  });
  ...
  describe('RailStationResponse', function() {
    it('should create an instance of RailStationResponse', function() {
      // uncomment below and update the code to test RailStationResponse
      //var instane = new AmadeusTravelInnovationSandbox.RailStationResponse();
      //expect(instance).to.be.a(AmadeusTravelInnovationSandbox.RailStationResponse);
    });
