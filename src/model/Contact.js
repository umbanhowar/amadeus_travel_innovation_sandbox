...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AmadeusTravelInnovationSandbox.Contact = factory(root.AmadeusTravelInnovationSandbox.ApiClient);
  }
   ...
   * @class
   * @param type {String} The method of contact, such as phone or fax.
   * @param detail {String} How that contact should be used, eg. a phone number
   */
  var exports = function(type, detail) {
    var _this = this;
