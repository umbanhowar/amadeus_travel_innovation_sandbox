...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AmadeusTravelInnovationSandbox.Airport = factory(root.AmadeusTravelInnovationSandbox.ApiClient);
  }
   ...
   * @class
   * @param airport {String} The 3 character <a href=\"https://en.wikipedia.org/wiki/International_Air_Transport_Association_airport_code\">IATA airport code</a> of the airport in question for this flight
   */
  var exports = function(airport) {
    var _this = this;
