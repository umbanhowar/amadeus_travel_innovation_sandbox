...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Airport', 'model/FlightReservationBookingInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Airport'), require('./FlightReservationBookingInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.AmadeusTravelInnovationSandbox) {
      root.AmadeusTravelInnovationSandbox = {};
    }
    root.AmadeusTravelInnovationSandbox.FlightReservationSegment = factory(root.AmadeusTravelInnovationSandbox.ApiClient, root.AmadeusTravelInnovationSandbox.Airport, root.AmadeusTravelInnovationSandbox.FlightReservationBookingInfo);
  }
}(this, function(ApiClient, Airport, FlightReservationBookingInfo) {
  'use strict';
  ...
  /**
   * The FlightReservationSegment model module.
   * @module model/FlightReservationSegment
   * @version 1.2
   */

  /**
   * Constructs a new <code>FlightReservationSegment</code>.
   * @alias module:model/FlightReservationSegment
   * @class
   * @param id {String} Uniquely identifies this flight in this travel record. This ID is persistent, and remains the same for the lifetime of the travel record.
   ...
   * @param bookingInfo {module:model/FlightReservationBookingInfo} A booking information object with additional details about how the quality of this flight at the given price.
   */
  var exports = function(id, departsAt, arrivesAt, origin, destination, marketingAirline, operatingAirline, flightNumber, travelerIds, bookingInfo) {
    var _this = this;
  ...
  /**
   * Constructs a <code>FlightReservationSegment</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FlightReservationSegment} obj Optional instance to populate.
   * @return {module:model/FlightReservationSegment} The populated <code>FlightReservationSegment</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('booking_info')) {
        obj['booking_info'] = FlightReservationBookingInfo.constructFromObject(data['booking_info']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/FlightReservationBookingInfo} booking_info
   */
